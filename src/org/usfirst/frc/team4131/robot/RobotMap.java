...
public class RobotMap {
	...
	public static final int SHOOTER_ENCODER_A = ROBOT_TYPE == PRAC_BOT_NUM ? 2 : 4;//2
	
	public static final int SHOOTER_ENCODER_B = ROBOT_TYPE == PRAC_BOT_NUM ? 3 : 5;//3
	...
	public static final int DRIVE_LEFT_ENCODERA = 0;//4

	public static final int DRIVE_LEFT_ENCODERB = 1;//5
	...
	public static final int ARMS_SWITCH = 1; //7
