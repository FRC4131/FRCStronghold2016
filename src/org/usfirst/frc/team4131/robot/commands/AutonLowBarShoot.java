...
public class AutonLowBarShoot extends CommandGroup {
	...
	private static final double speed = 0.65, distance = 500, shotAngle = 47, shotDistance = 0;//Practice bot far shot
	...
	public AutonLowBarShoot() {
		...
		addSequential(new TurnToAtRate(shotAngle, speed - 0.15));
...
//		addSequential(new VisionFire());//vision assisted fire* will fire immediately if no camera is found
